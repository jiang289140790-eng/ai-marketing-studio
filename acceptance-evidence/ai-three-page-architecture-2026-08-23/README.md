...
- 浏览器测试数据源/契约模拟（fake edge，非真实服务端）：
  1. 浏览器 → http://127.0.0.1:8937/ai-marketing-studio/#/ai（新任务首页）：harnessClient.plan/confirm → fake edge（镜像 harness-command 契约，仅本测试进程注入）→ 任务创建与人工确认；
...
- 演示任务编号：ht-98b1ae2e-cc20-434a-afdf-1cba2e04892b（成功）、ht-daa98eed-4890-4dce-b897-c8cb804d53b7（失败）。
- 截图对应路由：execution-detail-1440 → #/ai-execution/ht-98b1ae2e-cc20-434a-afdf-1cba2e04892b；results-* → #/ai-results/ht-98b1ae2e-cc20-434a-afdf-1cba2e04892b；
  execution-failed-1440 → #/ai-execution/ht-daa98eed-4890-4dce-b897-c8cb804d53b7；home-1440 → #/ai。
