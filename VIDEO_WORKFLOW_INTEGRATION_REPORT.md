...
- 线上地址：`https://jiang289140790-eng.github.io/ai-marketing-studio/?v=7f5fd61`
- 网站提交：`7f5fd61`
- 生成服务提交：`2fb1d0d`
- Bridge 镜像：`ai-marketing-studio-runtime:video-day-link-20260726`
- 已在登录后的“工作流与模型”页面确认 6 个生产工作流可见，其中 3 个视频工作流显示为“已验证、已启用”。
- 已在“X 媒体优先短内容测试”内容工作台确认视频模式可切换。
- 视频脚本已同步当前标题、正文语义、CTA、策略、平台与 Emma 角色。
- 已在素材库确认 AutoDL 生成的图片和视频结果均可见，并与当前 Campaign 及内容记录关联。
- 后续新生成素材同时保存 `day` 与 `day_index`，用于素材库按 Day 筛选。
