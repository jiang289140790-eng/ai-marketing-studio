...
export const productionWorkflowCapabilities = [
  ...
  {
    id: 'persephone_klein_outfit_edit_api_v1',
    name: 'Persephone 局部换衣 / 改造型',
    description: '使用已验证的 Flux2-Klein + PainterFluxImageEdit 局部重绘链路，上传原图与遮罩，只修改衣服、发型或造型区域。',
    mode: 'image',
    category: 'image_edit',
    status: 'validated',
    model: 'Flux2-Klein-9B',
    checkpoint: 'flux/flux-2-klein-9b-fp8.safetensors',
    loras: ['可选：当前角色 LoRA / 风格 LoRA'],
    input_schema: {
      required: ['input_image', 'mask_image', 'edit_instruction'],
      properties: { input_image: {}, mask_image: {}, edit_instruction: {}, seed: {}, width: {}, height: {} },
    },
    output_schema: { properties: { image: {} } },
    default_params: {
      ...
      edit_engine: 'PainterFluxImageEdit',
      mask_expand: 6,
      mask_feather: 10,
      denoise: 1,
    },
    tags: ['persephone', 'flux2-klein', 'local-edit', 'outfit', 'mask', 'production'],
    source: 'autodl_registry',
    last_synced_at: verifiedAt,
  },
  {
    id: 'persephone_klein_body_repair_api_v1',
    name: 'Persephone 局部修手 / 修脸 / 修身体',
    description: '使用已验证的 Flux2-Klein 局部重绘链路，针对手、脸、肢体或局部畸变做小范围修复。',
    mode: 'image',
    category: 'image_edit',
    status: 'validated',
    model: 'Flux2-Klein-9B',
    checkpoint: 'flux/flux-2-klein-9b-fp8.safetensors',
    loras: ['可选：当前角色 LoRA / 皮肤与细节 LoRA'],
    input_schema: {
      required: ['input_image', 'mask_image', 'edit_instruction'],
      properties: { input_image: {}, mask_image: {}, edit_instruction: {}, seed: {}, width: {}, height: {} },
    },
    ...
    tags: ['persephone', 'flux2-klein', 'local-edit', 'repair', 'hands', 'face', 'mask', 'production'],
    source: 'autodl_registry',
    last_synced_at: verifiedAt,
  },
  {
    id: 'persephone_klein_background_edit_api_v1',
    name: 'Persephone 局部改背景 / 改场景',
    description: '使用已验证的 Flux2-Klein 局部重绘链路，上传原图与背景遮罩，只替换背景或场景区域。',
    mode: 'image',
    category: 'image_edit',
    status: 'validated',
    model: 'Flux2-Klein-9B',
    checkpoint: 'flux/flux-2-klein-9b-fp8.safetensors',
    loras: ['可选：当前角色 LoRA / 场景风格 LoRA'],
    input_schema: {
      required: ['input_image', 'mask_image', 'edit_instruction'],
      properties: { input_image: {}, mask_image: {}, edit_instruction: {}, seed: {}, width: {}, height: {} },
    },
    ...
    tags: ['persephone', 'flux2-klein', 'local-edit', 'background', 'scene', 'mask', 'production'],
    source: 'autodl_registry',
    last_synced_at: verifiedAt,
  },
  {
